            ...
            <div className="steps">
                ...
                <div className="row mt-5">
                    <div className="col-lg-6">
                        <div style={{display: 'flex'}}>
                            <div>
                                <h2 style={{color: '#F7931A', fontWeight: 'bold'}}>01</h2>
                            </div>
                            <div className="ml-4">
                    ...
                    <div className="col-lg-6">
                        <div style={{display: 'flex'}}>
                            <div>
                                <h2 style={{color: '#F7931A', fontWeight: 'bold'}}>02</h2>
                            </div>
                            <div className="ml-4">
                ...
                <div className="row mt-lg-5 mt-0">
                    <div className="col-lg-6">
                        <div style={{display: 'flex'}}>
                            <div>
                                <h2 style={{color: '#F7931A', fontWeight: 'bold'}}>03</h2>
                            </div>
                            <div className="ml-4">
                                <h5 className="rate-text mt-1">Initiate A Trade</h5>
                                <p className="steps-p">
                                Click on the "Start Trade" button on your dashboard to start a trade.
                                Select the brand of card you want to sell in "Category". The "Subcategory" option is for you to be more specific with your type of card. Enter the total amount of the Crypto you want to trade.
                    ...
                    <div className="col-lg-6">
                        <div style={{display: 'flex'}}>
                            <div>
                                <h2 style={{color: '#F7931A', fontWeight: 'bold'}}>04</h2>
                            </div>
                            <div className="ml-4">
