    ...
    return ( 
        ...
        <Modal show={showModal}
         onHide={handleClose}>
            ...
            {/* <div className="text-center contain-head mt-3 mt-lg-6">
                <h3 className="login-text">Login</h3>
            </div> */}
            {/* <div>
                <div className="d-none d-md-block" style={{position: 'absolute', left: '70px', top: '0px'}} >
                    <img alt="loginicon " src={loginCurve} width="80" height="50" />
                </div>
                <div className="text-center contain-head mt-3 mt-lg-6" style={{position: 'relative', left: '0px', top: '0px'}}>
                <h3 className="login-text">Login</h3>
            </div>
            </div> */}
            ...
            <div className="container modal-contain">
                  ...
                  {({
                      ...
                      <Form onSubmit={handleSubmit}>
                          {/* email */}
                            ...
                            <Link to="/" onClick={handleShowForgot} className='align-right' style={{textDecoration: 'none', color: '#E69A25'}}>
                              <p style={{fontWeight: 600, fontSize: 14}}>Forgot Password?</p>
                            </Link>
              ...
              <div className="text-center mt-4">
                <p style={{color:'#2C3A50', fontSize: 14}} className="mb-0">Don't have an account yet? <Link to="/" onClick={handleShowRegister} style={{textDecoration: 'none', color:'#E69A25'}}>Register</Link></p>
            </div>
      ...
      <Modal show={showRegister}
       ...
       onHide={handleCloseRegister}>
           ...
           <Modal.Header >
            ...
            <div className="container modal-contain">
                <div className="text-center">
                <h3  style={{fontWeight: 'bold'}} className="login-text">Register</h3>
              ...
              <div className="text-center mt-4">
                <p style={{color:'#2C3A50', fontSize: 14}} className="mb-0">By clicking the REGISTER button below, you agree to OlaExchange <Link to="/terms" style={{textDecoration: 'none', color:'#0898D7'}}>Terms of use.</Link></p>
            </div>
                ...
                <div className="header">
                    ...
                    <nav className={ navShow ? "open" : "" }>
                        <ul className="mainNav">
                            ...
                            {/* <li className="navLink">
                                <a className="" href="https://blog.OlaExchange.com" target="_blank" rel="noreferrer" >Blog</a>
                            </li> */}
                            <li className="navLink">
