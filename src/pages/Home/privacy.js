        ...
        <div className="container" style={{marginTop: '120px'}}>
            ...
            <div className="faqDiv">
                ...
                <div className="faqHead">
                    <p>
                    This Privacy policy between TACITCHAIN (OlaExchange) and you, constitutes our commitment to your privacy on our website, apps, social media platforms, administrative records and premises.
                    </p>     
                </div>
                ...
                <div>
                    ...
                    <div className="mt-3">
                        <p>
                        This Privacy Policy describes your privacy rights regarding our collection, use, storage, sharing and protection of your personal information. It applies to the OlaExchange website, apps, platforms and all database applications, services, tools and physical contact with us regardless of how you access or use them.
                        </p>
                        <p>
                        If you have created a username, identification code, password or any other piece of information as part of our access security measures, you must treat such information as confidential, and you must not disclose it to any third party. We reserve the right to disable any user identification code or password, whether chosen by you or allocated by us, at any time, if in our opinion you have failed to comply with any of the provisions of these Conditions. If you know or suspect that anyone other than you know your security details, you must promptly notify us at <a href="mailto:support@OlaExchange.com"  style={{textDecoration: 'none'}}>support@OlaExchange.com</a>. 
                        </p>
                    ...
                    <div className="mt-3">
                        <p>
                        When you use OlaExchange's Services, we may collect information sent to us by your computer, mobile phone or other electronic access device. The automatically collected information includes but not limited to- data about the pages you access, computer IP address, device ID or unique identifier, device type, geo-location information, computer and connection information, mobile network information, statistics on page views, traffic to and from the sites, referral URL, ad data, standard web log data, still and moving images.
                        </p>
                        <p>
                        We may also collect information you provide us including but not limited to - information on web forms, survey responses, account update information, email, phone number, organization you represent, official position, correspondence with OlaExchange's support services and telecommunication with OlaExchange. We may also collect information about your transactions, enquiries and your activities on our platforms or service channels. 
                        </p>
                        <p>
                        We may also use information provided by third parties like social media sites. Information about you provided by other sites are not controlled by OlaExchange and we are therefore not liable for how they use it. 
                        </p>
                    </div>
                    ...
                    <div className="mt-3">
                       ...
                       <ol>
                           <li>
                            Provide OlaExchange's Services and support;
                           </li>
                           <li>
                           ...
                           <li>
                            Improve OlaExchange's Services by implementing aggregate customer or user preferences;
                           </li>
                           <li>
                                To provide ‘after-transaction’ services or other customer support services
                           </li>
                           <li>
                            	Measure the performance of the OlaExchange's Services and improve content, technology and layout;
                           </li>
                           <li>
                    ...
                    {/* sixth */}
                    <div className="mt-4">                
                            <h6 style={{fontWeight: 800}}>6.0 How We Share your information within OlaExchange and other users</h6>
                    </div>
                    <div className="mt-3">
                        <p>
                        ...
                        <p>
                        We work with third parties, banks, financial institutions and corporate bodies to perform OlaExchange's services and implement its mandate. In doing so, a third party may share information about you with us, such as your email address or mobile phone number.
                        </p>
                        <p>
                        You accept that your pictures and testimonials on all social media platforms about OlaExchange can be used for limited promotional purposes by us. This does not include your trademarked or copyrighted materials.
                        </p>
                        <p>
                        From time to time we may send you relevant information such as news items, enforcement notice, statutorily mandated notices and other informative notices to help OlaExchange serve you better. We may also share your personal information in compliance with National or international laws; crime prevention and risk management agencies and service providers.
                        </p>
                    ...
                    <div className="mt-3">
                        ...
                        <p>
                        OlaExchange has also taken measures to comply with global Information Security Management Systems (ISMS) we therefore have put in place digital and physical security measures to limit or eliminate possibilities of data privacy breach incidents.
                        </p>
                    ...
                    <div className="mt-3">
                        <p>
                        Your information is regarded as confidential and will not be divulged to any third party except under legal and/or regulatory conditions. You have the right to request sight of, and copies of any and all information we keep on you. While OlaExchange is responsible for safeguarding the information entrusted to us, your role in fulfilling confidentiality duties includes, but is not limited to, adopting and enforcing appropriate security measures such as non-sharing of passwords and other platform login details, adherence with physical security protocols on our platforms, dealing with only authorized officers of OlaExchange.
                        </p>
                    ...
                    <div className="mt-3">
                       ...
                       <h6 style={{fontWeight: 800}}>Scope</h6>
                        ...
                        <p>
                        OlaExchange's employees must follow this policy. Freelancers, consultants, partners and any other external entity are also covered. Generally, our policy refers to anyone we collaborate with or acts on our behalf and may need occasional access to data.
                        </p>
...
OlaExchange collects this information in a transparent way and only with the full cooperation and knowledge of interested parties. Once this information is available to us, the following rules apply.
                        </p>
...
In addition to ways of handling data, OlaExchange has direct obligations towards people to whom the data belongs. Specifically we:
