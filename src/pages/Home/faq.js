...
Kindly check your spam folder if you don't find it in your inbox. Our support team is always available to assist
        ...
        {
          title: 'What Crypto Has The Highest Rate At The Moment',
          content: () => (
            <>
...
If you need any specific help or more advice concerning this, you can reach out to our customer support via live chat or call/WhatsApp: +2348168516315
      ...
      - Your Crypto is already redeemed.

    - Your Crypto is not ‘properly’ activated

    - Your Crypto is not clear enough

    - Your Crypto code is wrong
...
Whatever reason it is will be specified along with the rejection. ​​​​​
        ...
        },
        {
          ...
          content: () => (
            <>
             Crypto transactions typically take a few minutes. However, some Cryptos like Apple Store, Walmart, Nordstrom e.t.c take more time than others.
